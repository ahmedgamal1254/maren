        ...
        <form action="{{ route("question.update") }}" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="form-group position-relative has-icon-left mb-0">
                ...
                <select name="type_question" id="" class="form-control form-control-lg">
                    <option value="{{ $question->type }}">أدخل عنصر</option>
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="chooses" id="desc" cols="30" rows="10"
                class="form-control form-control-lg input-lg"
                value="" id="email" placeholder="أدخل الاختيارات للسؤال مثل صح,خطأ">{{ $question->chooses }}</textarea>
            </div>
            ...
            <fieldset class="form-group position-relative has-icon-left mb-0">
                <input type="text" name="answer"
                       class="form-control form-control-lg input-lg"
                       value="{{ $question->answer }}" id="" placeholder="أدخل اجابة السؤال">
                <div class="form-control-position">
                    <i class="fa fa-school"></i>
                </div>
            ...
            <fieldset class="form-group position-relative has-icon-left mb-0">
                ...
                <select name="subject_id" id="" class="form-control form-control-lg">
                    <option value="{{ $question->subject_id }}">أدخل اسم الوحدة الدراسية</option>

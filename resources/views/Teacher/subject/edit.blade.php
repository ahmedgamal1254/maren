        ...
        <form action="{{ route("subject.update") }}" method="post">
            ...
            <fieldset class="form-group position-relative has-icon-left mb-0">
                <input type="text" name="title"
                       ...
                       value="{{ $subject->title }}" id="email" placeholder="أدخل اسم المادة">
            ...
            <fieldset class="form-group position-relative has-icon-left mb-0">
                ...
                <textarea type="text" name="description" id="desc" cols="30" rows="10"
                       class="form-control form-control-lg input-lg"
                       id="email" placeholder="أدخل وصف الماد">{{ $subject->description }}</textarea>
            ...
            <fieldset class="form-group position-relative has-icon-left mb-0">
                ...
                <select name="school_grade_id" id="" class="form-control form-control-lg">
                    <option value="{{ $subject->school_grade_id }}">أدخل اسم المرحلة الدراسية</option>

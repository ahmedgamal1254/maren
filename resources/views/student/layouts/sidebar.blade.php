...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href="{{ route("month_page_books",["teacher_id"=>$data["teacher_id"],
                "id"=>$data["month_id"]]) }}"><i class="fa fa-book"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">الكتب والملخصات</span></a>
            </li>

            <li class="nav-item"><a href="{{ route("posts_student_teacher",["teacher_id"=>$data["teacher_id"],
            "month_id"=>$data["month_id"]]) }}"><i class="fa fa-blog"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">المنشورات</span></a>
            </li>

            <li class="nav-item"><a href="{{ route("month_page_lessons",["teacher_id"=>$data["teacher_id"],
                "id"=>$data["month_id"]]) }}"><i class="fa fa-video"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">الفيديوهات</span></a>
            </li>

            <li class="nav-item"><a href="{{ route("month_page_exam",["teacher_id"=>$data["teacher_id"],
                "id"=>$data["month_id"]]) }}"><i class="fa-solid fa-graduation-cap"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">الامتحانات</span></a>
            </li>

            <li class="nav-item"><a href="{{ route("payments",["id"=>$data["teacher_id"]]) }}"><i class="fa-solid fa-dollar"></i><span
